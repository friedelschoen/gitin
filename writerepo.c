...
static int writelog(FILE* fp, const struct repoinfo* info, const git_oid* oid) {
...
static int writefiles(FILE* fp, const struct repoinfo* info, const char* relpath, const git_oid* id) {
	git_tree*   tree   = NULL;
